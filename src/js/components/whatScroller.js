export let whatScroller = () => {
  //   // Create array of elements to tween on
  //   const boxes = gsap.utils.toArray(".singleScroller");
  ...
  $(".singleScroller").each(function () {
    let width = $(this).outerWidth();
    // console.log(width);
    totalScrollWidth += parseInt(width);
  });

  // console.log("total els width", totalScrollWidth);
  // console.log("scroll width", actualInnerWidth);
  // Total Length of all elements minus the Visible Window plus 80px for the 40px of padding left/right added in CSS
  let scrollDistance = totalScrollWidth - actualInnerWidth + 80;

  let tl = gsap.timeline({
    scrollTrigger: {
      trigger: ".what-scroller",
      start: "top bottom-=20",
      endTrigger: ".what-scroller",
      end: "bottom top-=150",
      scrub: true,
  ...
  tl.to(".what-scroller-inner", { x: "-" + scrollDistance });
};
